...
module.exports = function(req, res, client, scope, user, redirectUri) {
    ...
    async.waterfall([
        ...
        function(cb) {
            accessTokenValue = req.oauth2.model.accessToken.generateToken(req.oauth2.model.user.getId(user), req.oauth2.model.client.getId(client), scope, req.oauth2.model.accessToken.ttl);
