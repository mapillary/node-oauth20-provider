...
module.exports = function(oauth2, client, code, redirectUri, pCb) {
    ...
    async.waterfall([
        ...
        function(cb) {
            refreshTokenValue = oauth2.model.refreshToken.generateToken(oauth2.model.code.getUserId(code), oauth2.model.code.getClientId(code), oauth2.model.code.getScope(code));
        ...
        function(cb) {
            accessTokenValue = req.oauth2.model.accessToken.generateToken(req.oauth2.model.user.getId(user), req.oauth2.model.client.getId(client), scope, req.oauth2.model.accessToken.ttl, function(err, token) {
