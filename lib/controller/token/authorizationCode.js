...
module.exports = function(oauth2, client, code, redirectUri, pCb) {
    ...
    async.waterfall([
        ...
        function(cb) {
            accessTokenValue = oauth2.model.accessToken.generateToken(oauth2.model.code.getUserId(code), oauth2.model.code.getClientId(code), oauth2.model.code.getScope(code), oauth2.model.accessToken.ttl);
