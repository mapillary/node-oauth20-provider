...
module.exports = function(oauth2, client, code, redirectUri, pCb) {
    ...
    async.waterfall([
        ...
        function(cb) {
            oauth2.model.accessToken.generateToken(oauth2.model.user.getId(user), oauth2.model.client.getId(client), scope, oauth2.model.accessToken.ttl, function(err, token) {
