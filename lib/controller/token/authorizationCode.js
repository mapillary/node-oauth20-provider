...
module.exports = function(oauth2, client, code, redirectUri, pCb) {
    ...
    async.waterfall([
        ...
        function(cb) {
            req.oauth2.model.accessToken.generateToken(req.oauth2.model.user.getId(user), req.oauth2.model.client.getId(client), scope, req.oauth2.model.accessToken.ttl, function(err, token) {
