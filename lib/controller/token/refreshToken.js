    ...
    async.waterfall([
        ...
        function(cb) {
            ...
            if (accessToken) {
                ...
                accessTokenValue = oauth2.model.accessToken.generateToken(oauth2.model.user.getId(user), oauth2.model.client.getId(client), oauth2.model.refreshToken.getScope(refreshToken), oauth2.model.accessToken.ttl);
