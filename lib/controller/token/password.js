...
module.exports = function(oauth2, client, username, password, scope, pCb) {
    ...
    async.waterfall([
        ...
        function(cb) {
            accessTokenValue = oauth2.model.accessToken.generateToken(oauth2.model.user.getId(user), oauth2.model.client.getId(client), scope, oauth2.model.accessToken.ttl);
